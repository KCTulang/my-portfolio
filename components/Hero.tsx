...
export const Hero = () => {
	return (
		<section className="min-h-screen w-full flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-28 pb-16">
			<div className="max-w-5xl mx-auto w-full space-y-10">
				<div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
					<div className="max-w-5xl mx-auto w-full">
						<div className="flex-1 space-y-10">
							{/* 1. Location Badge */}
							<div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[--color-charcoal]/5 border border-[--color-charcoal]/10 text-xs font-semibold tracking-widest uppercase text-[--color-charcoal] hover:border-(--color-crimson)/30 hover:text-(--color-crimson) hover:bg-(--color-crimson)/5 transition-all duration-300 cursor-default">
								📍 Taguig City
							</div>
							...
							<div className="flex items-start gap-6 max-w-xl">
								...
								<p className="text-base md:text-lg text-[--color-charcoal] leading-relaxed">
									...
									things for the web. I'm a CS student at PUP Sta. Mesa figuring
									it all out — one component at a time.
								</p>
							</div>
							...
							<div className="flex flex-wrap gap-10 border-t border-[--color-charcoal]/10 pt-10">
								{[
									...
									>
										<p className="text-sm font-black tracking-tight text-(--color-rich-black) group-hover:text-(--color-crimson) transition-colors duration-300">
											{stat.value}
										</p>
					...
					<div className="relative shrink-0 w-64 md:w-72 lg:w-120">
						<div className="absolute inset-0 bg-(--color-rich-black)/8 rounded-full scale-120 blur-xl" />
						<Image
							src="/Image/KC.png"
