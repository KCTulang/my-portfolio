...
export default function Navbar() {
	...
	const getLinkClasses = (isActive: boolean) => {
		const baseClasses =
			"block rounded-full px-4 py-2 text-xs font-bold uppercase tracking-widest transition-all duration-300 ease-in-out";
		const activeClasses =
			"bg-crimson/10 text-crimson dark:bg-watermelon/10 dark:text-watermelon";
		const inactiveClasses =
			"text-charcoal hover:bg-crimson/10 hover:text-crimson dark:text-ivory/70 dark:hover:text-watermelon";
